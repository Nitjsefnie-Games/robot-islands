  ...
  it('records per-resource node-holders ONLY for islands holding that node', () => {
    const mk = (id: string, nodes: string[], inv: Record<string, number>): IslandState =>
      ({
        ...
        funnelPending: {} as any, declaredAt: null, aiCoreCrafted: false, ascendantCoreCrafted: false,
    ...
    const world: WorldState = {
      ...
      endgameState: { achieved: new Set(), firstAchievedMs: null }, latticeActive: false,
