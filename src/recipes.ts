...
export const RESOURCE_META: Readonly<Record<ResourceId, ResourceMeta>> = {
  ...
  heavy_cable: { massPerUnitKg: 8, terminal: 'gameplay-sink' },
  battery: { massPerUnitKg: 5, energyPerUnitKWh: 1, terminal: 'consumed' },
  glass_panel: { massPerUnitKg: 3, terminal: 'gameplay-sink' },
  ...
  plasma_charge: { massPerUnitKg: 1, energyPerUnitKWh: 10, terminal: 'gameplay-sink' },
