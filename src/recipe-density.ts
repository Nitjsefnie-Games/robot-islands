...
export const BUILDING_ARCHETYPE: Partial<Record<BuildingDefId, Archetype>> = {
  ...
  kerosene_refinery: 'crude_refining', lubricant_refinery: 'crude_refining', tar_refinery: 'crude_refining',
  vapor_condenser: 'air_separation', cryo_reliquefier: 'air_separation', mill_scale_sinter: 'blast_furnace',
